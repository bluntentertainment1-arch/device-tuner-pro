...
struct HowToUseView: View {
    ...
    private let steps = [
        ...
        HowToUseStep(
            number: "4",
            title: "Add Games to Active Session",
            description: "Tap the + button in the Active Gaming Session card to add your favorite games.\n\nOnce added, launch your games directly from the session for optimized performance monitoring.",
            icon: "plus.app.fill",
            ...
            VStack(spacing: 0) {
                ...
                TabView(selection: $currentStep) {
                    ForEach(0..<steps.count, id: \.self) { index in
                        HowToUseStepView(step: steps[index])
                            .tag(index)
                    }
                }
